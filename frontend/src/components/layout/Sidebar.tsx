...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Main Sidebar Container (Desktop Collapsible & Mobile Off-canvas Drawer) */}
      <aside
        className={`bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col flex-shrink-0 transition-all duration-300 z-50 ${
          /* Mobile Drawer styles */
          'fixed lg:static top-0 bottom-0 left-0 h-full shadow-2xl lg:shadow-none'
        } ${
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className="hidden lg:block p-1.5 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
